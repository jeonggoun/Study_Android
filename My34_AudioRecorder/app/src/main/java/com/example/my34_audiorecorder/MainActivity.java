    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button1).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                recorder.setAudioSource(MediaRecorder.AudioSource.MIC); //마이크를 써서 녹음해라
        ...
        findViewById(R.id.button3).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MainActivity.this, "녹음 파일을 재생합니다.", Toast.LENGTH_SHORT).show();
                try {
        ...
        findViewById(R.id.button4).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(player != null){
                    ...
                    Toast.makeText(MainActivity.this, "녹음 파일 재생을 중지합니다.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
