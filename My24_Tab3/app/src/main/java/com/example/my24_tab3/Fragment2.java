...
public class Fragment2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (activity.mBundle != null) {
            ...
            activity.mBundle = null; //null로 만들어줘야 두번째 탭 눌러주어도 TextView 나오게 할 수 있다
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putSerializable("person2", person2);    //person2로 보낼 것
                bundle.putInt("index", 1);    //몇 번째 버튼을 눌렀나

                // 메인 액티비티에 번들 만들어서 보내기
                activity.fragBtnClick(bundle);

                // 메인 액티비티에 프래그먼트3으로 화면전환 요청
